...
public class Tower : MonoBehaviour
{
    ...
    public void ShootTarget()
    {
        ...
        {
            bool headHasAimed = Mathf.Abs(towerHead.transform.rotation.eulerAngles.z - _targetRotation.eulerAngles.z) < 10f;
            if (!headHasAimed)
            {
                return;
            }
    ...
    public void SeekTarget()
    {
        ...
        towerHead.transform.rotation = Quaternion.RotateTowards(towerHead.transform.rotation, _targetRotation, Time.deltaTime * 180f);
    }
